...
var ExampleStore = function ExampleStore(_ref8) {
  var key = _ref8.key,
      state = _ref8.state;
  return div([div(['key: ', key]), div([h4('controls'), button({
    onclick: [actions.examplestore.set, {
      key: key
    }]
  }, 'write'), button({
    onclick: [actions.examplestore.get, {
      key: key
    }]
  }, 'read'), button({
    onclick: [actions.examplestore.del, {
      key: key
    }]
  }, 'delete')]), div('value in local storage:'), state[key] ? ["state is accessible via state['".concat(key, "']"), div(state[key])] : div('no value in db')]);
};
...
var Gdpr = function Gdpr(_ref9) {
  var _ref9$gdpr = _ref9.gdpr,
      gdpr = _ref9$gdpr === void 0 ? {} : _ref9$gdpr,
      _ref9$cookies = _ref9.cookies,
      cookies = _ref9$cookies === void 0 ? [] : _ref9$cookies;
  var show = gdpr.show,
  ...
  return div({
    ...
    "class": 'Container'
  }, [title && h3(title), content && p(content), hasCookies && [ul(cookies.map(function (_ref10) {
    var name = _ref10.name,
        title = _ref10.title,
        content = _ref10.content,
        _ref10$allowed = _ref10.allowed,
        allowed = _ref10$allowed === void 0 ? false : _ref10$allowed;
    return li({
      "class": 'Cookie'
    }, [input({
      type: 'checkbox',
...
var Link = function Link(_ref14, children) {
  var to = _ref14.to,
      p = _objectWithoutProperties(_ref14, ["to"]);
...
var Page = function Page(_ref15, children) {
...
var Route = function Route(_ref16) {
...
var lib = {
  db: function () {
    ...
    var set = function set(dispatch, _ref17) {
    ...
    var get = function get(dispatch, _ref18) {
    ...
    var del = function del(dispatch, _ref19) {
...
var actions = {
  ...
  'examplestore': {
    'del': function del(state, _ref20) {
      var key = _ref20.key;
      return [state, [lib.db.del, {
        key: key,
        action: actions.examplestore.refresh
      }]];
    },
    'get': function get(state, _ref21) {
      var key = _ref21.key;
      return [state, [lib.db.get, {
        key: key,
        action: actions.examplestore.refresh
      }]];
    },
    'refresh': function refresh(state, _ref22) {
      var key = _ref22.key,
          value = _ref22.value;
      console.log('refresh', {
        key: key,
    ...
    'set': function set(state, _ref23) {
      var key = _ref23.key;
      return [state, [lib.db.set, {
        key: key,
        value: "testing ".concat(Math.ceil(Math.random() * 100000)),
        action: actions.examplestore.refresh
      }]];
    }
  },
  'gdpr': {
    ...
    'toggleAllow': function toggleAllow(state, _ref24) {
  ...
  'pre': {
    'clip': function clip(state, _ref25) {
